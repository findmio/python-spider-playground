 ...
 * 扇贝单词 单词本
 *
 * 链接：https://web.shanbay.com/wordsweb/#/words-table
 *
 * 思路：
 * 接口无参数校验，响应数据加密
 * 通过 xhr 调用堆栈去找到接收响应数据，然后解密的地方
 *
 */
...
var window = new Proxy(
    {},
    {
        get: function (target, property, receiver) {
            // console.log(`访问 window, ${property}`);
            return target[property];
        },
        set: function (target, property, value) {
            // console.log(`设置 window 的属性 ${property}，值为 ${value}`);
...
!(function (t, e) {
    ...
    return (function (r) {
        ...
        function (t, e, r) {
            ...
            var f = (function () {
                    function t() {
                        i(this, t), (this._char = "."), (this._children = {});
                    }
                    return (
                        n(t, [
                            {
                            ...
                            },
                            {
                                ...
                                value: function (t, e) {
                                    var r = this,
                                        ...
                                        o = "";
                                    return (
                                        u.default.loop(e, function (t) {
                                            for (
                                                var e =
                                                    s[r._random.generate(32)];
                                                e in n.getChildren() &&
                                                "." !==
                                                    n
                                                        .getChildren()
                    ...
                    var b64chars =
                        ...
                        cb_encode = function (t) {
                            var e = [0, 2, 1][t.length % 3],
                                r =
                                    (t.charCodeAt(0) << 16) |
                                    ((1 < t.length ? t.charCodeAt(1) : 0) <<
                                        8) |
                                    (2 < t.length ? t.charCodeAt(2) : 0);
                            return [
                                b64chars.charAt(r >>> 18),
                                b64chars.charAt((r >>> 12) & 63),
                                2 <= e ? "=" : b64chars.charAt((r >>> 6) & 63),
                                1 <= e ? "=" : b64chars.charAt(63 & r),
                            ].join("");
                        },
                        btoa = global.btoa
                            ? function (t) {
                        ...
                        cb_decode = function (t) {
                            var e = t.length,
                                r = e % 4,
                                n =
                                    (0 < e ? b64tab[t.charAt(0)] << 18 : 0) |
                                    (1 < e ? b64tab[t.charAt(1)] << 12 : 0) |
                                    (2 < e ? b64tab[t.charAt(2)] << 6 : 0) |
                                    (3 < e ? b64tab[t.charAt(3)] : 0),
                                o = [
                                    fromCharCode(n >>> 16),
                    ...
                    n(r, [
                        {
                            ...
                            value: function (e) {
                                ...
                                o.default.loop(4, function (t) {
                                    e.length > t
                                        ? (r._status[t] = u.default.get(
                                              e.charAt(t).charCodeAt()
                                          ))
                                        : (r._status[t] = u.default.get(110));
                                }),
                        ...
                        },
                        {
                            ...
                            value: function () {
                                ...
                                (e = this._status[3]),
                                    ...
                                    (t = u.default.xor(
                                        t,
                                        u.default.shiftLeft(t, 1)
                                    )),
                                    (e = u.default.xor(
                                        e,
                                        u.default.xor(
                                            u.default.shiftRight(e, 1),
                                            t
                                        )
                                    )),
                                    (this._status[0] = this._status[1]),
                                    (this._status[1] = this._status[2]),
                                    (this._status[2] = u.default.xor(
                                        t,
                                        u.default.shiftLeft(e, 10)
                                    )),
                                    (this._status[3] = e),
                                    (this._status[1] = u.default.xor(
                                        this._status[1],
                                        u.default.and(
                                            -u.default.and(e, 1),
                                            this._mat1
                        ...
                        },
                        {
                            ...
                            value: function (t) {
                                ...
                                return (
                                    ...
                                    (e = u.default.xor(
                                        this._status[0],
                                        u.default.shiftRight(this._status[2], 8)
                                    )),
                                    (r = u.default.xor(r, e)),
                                    (r = u.default.xor(
                                        u.default.and(
...
const decode = (data) => JSON.parse(window.bays4.d(data));

async function main() {
    const response = await axios(
        "https://apiv3.shanbay.com/wordsapp/user_material_books/brfxs/learning/words/unlearned_items?ipp=10&page=1",
        {
            headers: {
                Cookie,
            },
